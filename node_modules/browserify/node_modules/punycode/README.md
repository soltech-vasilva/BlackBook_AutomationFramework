...
Once that’s done, you can run the unit tests in Node using `npm TestAutomation` or `node tests/tests.js`. To run the tests in Rhino, Ringo, Narwhal, PhantomJS, and web browsers as well, use `grunt TestAutomation`.
