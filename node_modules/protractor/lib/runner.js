...
/*
 * Runner is responsible for starting the execution of a TestAutomation run and triggering
...
/**
 * Execute the Runner's TestAutomation cases through Jasmine.
 *
 * @private   
...
Runner.prototype.runJasmine_ = function(specs, done) {
  ...
  }, 'run TestAutomation preparers').then(function() {
...
/**
 * Execute the Runner's TestAutomation cases through Mocha.
 *
 * @private   
 * @param {Array} specs Array of Directory Path Strings
 * @param done A callback for when tests are finished.
...
/**
 * Execute the Runner's TestAutomation cases through Cucumber.
 *
 * @private   
 * @param {Array} specs Array of Directory Path Strings
 * @param done A callback for when tests are finished.
...
/**
 * Responsible for cleaning up TestAutomation run and exiting the process.
 * @private
...
/**
 * Sets up convenience globals for TestAutomation specs
 * @private   
 */
...
/**
 * The primary workhorse interface. Kicks off the TestAutomation running process.
 *
...
Runner.prototype.run = function() {
  ...
  // 2) Execute TestAutomation cases
  }).then(function() {
