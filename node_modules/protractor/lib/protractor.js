...
var Protractor = function(webdriver, opt_baseUrl, opt_rootElement) {
  ...
  /**
   * An object that holds custom TestAutomation parameters.
   *
   * @type {Object}
   */
  this.params = {};
...
/**
 * Pauses the TestAutomation and injects some helper functions into the browser, so that
 ...
 * Jasmine TestAutomation frames and webdriver promise resolution.
