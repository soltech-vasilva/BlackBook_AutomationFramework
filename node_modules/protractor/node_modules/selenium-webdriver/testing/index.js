 ...
 *     TestAutomation = require('selenium-webdriver/testing');
 *
 * TestAutomation.describe('Google Search', function() {
 *   var driver, server;
 *
 *   TestAutomation.before(function() {
 ...
 *   });
 *
 *   TestAutomation.after(function() {
 *     driver.quit();
 *     server.stop();
 *   });
 *
 *   TestAutomation.it('should append query to title', function() {
 ...
 * </code></pre>
 *
 * <p>You may conditionally suppress a TestAutomation function using the exported
 * "ignore" function. If the provided predicate returns true, the attached
 * TestAutomation case will be skipped:
 * <pre><code>
 *   TestAutomation.ignore(maybe()).it('is flaky', function() {
...
/**
 * Ignores the TestAutomation chained to this function if the provided predicate returns
 * true.
 * @param {function(): boolean} predicateFn A predicate to call to determine
 *     if the TestAutomation should be suppressed. This function MUST be synchronous.
...
/**
 * Registers a new TestAutomation suite.
 * @param {string} name The suite name.
 * @param {function()=} fn The suite function, or {@code undefined} to define
 *     a pending TestAutomation suite.
 */
exports.describe = global.describe;

/**
 * Defines a suppressed TestAutomation suite.
 * @param {string} name The suite name.
 * @param {function()=} fn The suite function, or {@code undefined} to define
 *     a pending TestAutomation suite.
 */
...
/**
 * Register a function to call after each TestAutomation in a suite.
 * @param {function()} fn .
 */
...
/**
 * Register a function to call before each TestAutomation in a suite.
 * @param {function()} fn .
 */
exports.beforeEach = wrapped(global.beforeEach);

/**
 * Add a TestAutomation to the current suite.
 * @param {string} name The TestAutomation name.
 * @param {function()=} fn The TestAutomation function, or {@code undefined} to define
 *     a pending TestAutomation case.
 */
exports.it = wrapped(global.it);

/**
 * An alias for {@link #it()} that flags the TestAutomation as the only one that should
...
/**
 * Adds a TestAutomation to the current suite while suppressing it so it is not run.
 * @param {string} name The TestAutomation name.
 * @param {function()=} fn The TestAutomation function, or {@code undefined} to define
 *     a pending TestAutomation case.
 */
