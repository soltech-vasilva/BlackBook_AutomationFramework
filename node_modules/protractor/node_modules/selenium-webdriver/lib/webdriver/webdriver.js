 ...
 * </pre></code>
 *
 * Example #2: Synchronizing a TestAutomation with an AJAX application:
 * <code><pre>
 ...
 * that the element is present on the page. To TestAutomation whether an element is
...
/**
 * Schedules a command to TestAutomation if an element is present on the page.
 *
 ...
 * TestAutomation if at least one element can be found with the given search criteria.
 *
 ...
 * will have an adverse effect on TestAutomation run time, especially when used with
 ...
 * as an assert that the element is present on the page. To TestAutomation whether an
...
/**
 * Schedules a command to TestAutomation if there is at least one descendant of this
...
/**
 * Schedules a command to TestAutomation whether this element is currently displayed.
 * @return {!webdriver.promise.Promise} A promise that will be resolved with
