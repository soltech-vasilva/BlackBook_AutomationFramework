 ...
 * namespace for the TestAutomation (e.g. 'goog.stringTest'). The linter will then
...
goog.setTestOnly = function(opt_message) {
  if (COMPILED && !goog.DEBUG) {
    ...
    throw Error('Importing TestAutomation-only code into non-debug environment' +
                opt_message ? ': ' + opt_message : '.');
  }
};
  ...
  goog.writeScriptTag_ = function(src) {
    if (goog.inHtmlDocument_()) {
      ...
      if (doc.readyState == 'complete') {
        // Certain TestAutomation frameworks load base.js multiple times, which tries
 ...
 * WARNING: Do not use this to TestAutomation if an object has a property. Use the in
 * operator instead.  Additionally, this function assumes that the global
 * undefined variable has not been redefined.
 * @param {*} val Variable to TestAutomation.
...
goog.globalEval = function(script) {
  if (goog.global.execScript) {
    ...
    // TestAutomation to see if eval works
    ...
    if (goog.evalWorksForGlobals_) {
      ...
      // Note(user): can't use .innerHTML since "t('<TestAutomation>')" will fail and
