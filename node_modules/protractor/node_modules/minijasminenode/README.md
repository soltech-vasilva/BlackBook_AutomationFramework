...
This will run passing tests as well as show examples of how failures look. To run only passing tests, use `npm TestAutomation` or `./bin/minijn spec/*_spec.js`
