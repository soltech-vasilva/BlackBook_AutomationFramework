...
exports.executeSpecs = function(options) {
  ...
  // Time to wait in milliseconds before a TestAutomation automatically fails
  ...
  for (var i = 0, len = specFiles.length; i < len; ++i) {
    ...
    // Catch exceptions in loading the spec files, and make them jasmine TestAutomation
    // failures.
    try {
