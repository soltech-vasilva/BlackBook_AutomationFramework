...
via PhantomJS. `make TestAutomation` and Travis-CI will now also rebuild and test `./chai.js`. Consequently, all
...
and include their credentials in `./TestAutomation/auth/sauce.json`.
