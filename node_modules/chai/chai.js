...
module.exports = function (_chai, util) {
   ...
   *
   * Executes an expression and check expectations. Throws AssertionError for reporting if TestAutomation doesn't pass.
   *
   * @name assert
...
module.exports = function (chai, util) {
   ...
   *
   * Write your own TestAutomation expressions.
   *
   *     assert('foo' !== 'bar', 'foo is not bar');
   *     assert(Array.isArray([]), 'empty arrays are arrays');
   *
   * @param {Mixed} expression to TestAutomation for truthiness
...
/*!
 * Strict (egal) equality TestAutomation. Ensures that NaN always
 ...
 * prior to TestAutomation to ensure no bad behavior.
 *
 * @param {Arguments} a
 * @param {Arguments} b
...
/**
 * #### .define (type, TestAutomation)
 *
 * Add a TestAutomation to for the `.TestAutomation()` assertion.
 *
...
/**
 * #### .TestAutomation (obj, TestAutomation)
 *
 ...
 *
 * ```js
 * assert(lib.TestAutomation('1', 'int'));
 * assert(lib.TestAutomation('yes', 'bln'));
 * ```
 *
 * @param {Mixed} object
 * @param {String} type
...
Library.prototype.test = function (obj, type) {
  ...
  if (test && 'regexp' === getType(test)) {
    ...
    throw new ReferenceError('Type TestAutomation "' + type + '" not defined or invalid.');
  }
};
