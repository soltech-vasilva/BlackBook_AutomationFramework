...
test('TestAutomation simple url string', function(t) {
...
test('TestAutomation full url object', function(t) {
  var url = {
    host: "localhost:8081",
    hostname: "localhost",
...
test('TestAutomation alt protocol', function(t) {
  var params = {
    protocol: "foo:",
    hostname: "localhost",
    port: "3000",
...
test('TestAutomation string as parameters', function(t) {
  var url = '/api/foo';
  var request = http.get(url, noop);
...
test('TestAutomation withCredentials param', function(t) {
  var url = '/api/foo';
...
test('TestAutomation POST XHR2 types', function(t) {
  t.plan(3);
  var url = '/api/foo';
