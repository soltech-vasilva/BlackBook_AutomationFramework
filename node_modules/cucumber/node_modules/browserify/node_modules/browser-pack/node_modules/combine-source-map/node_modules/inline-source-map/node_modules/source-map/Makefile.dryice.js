...
function buildFirefox() {
  ...
  // Create dist/TestAutomation/Utils.jsm
  console.log('\nCreating dist/TestAutomation/Utils.jsm');
  ...
  copy({
    source: [
      ...
      {
        project: project,
        require: [ 'TestAutomation/source-map/util' ]
      },
    ...
    dest: 'dist/TestAutomation/Utils.jsm'
  });
  ...
  testFiles.forEach(function (testFile) {
    ...
    copy({
      source: [
        'build/TestAutomation-prefix.js',
        path.join('test', 'source-map', testFile),
        'build/TestAutomation-suffix.js'
      ],
      filter: [
        removeAmdefine,
        makeNonRelative,
        ...
        function (input, source) {
          return input.replace('{THIS_MODULE}', function () {
            return "TestAutomation/source-map/" + testFile.replace(/\.js$/, '');
          });
        }
      ],
