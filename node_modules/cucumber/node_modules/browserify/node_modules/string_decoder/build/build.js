...
const hyperquest  = require('hyperzip')(require('hyperdirect'))
    ...
    , testsrcurl  = srcurlpfx + 'TestAutomation/simple/'
    , testlisturl = 'https://github.com/joyent/node/tree/v' + process.argv[2] + '-release/TestAutomation/simple'
    , libourroot  = path.join(__dirname, '../')
    , testourroot = path.join(__dirname, '../TestAutomation/simple/')
...
//--------------------------------------------------------------------
// Discover, grab and process all TestAutomation-string-decoder* files on joyent/node
...
//--------------------------------------------------------------------
// Grab the joyent/node TestAutomation/common.js
