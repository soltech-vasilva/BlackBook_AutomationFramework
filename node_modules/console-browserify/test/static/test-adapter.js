    ...
    function tapAdapter(socket){
        ...
        Testem.handleConsoleMessage = function(msg){
            ...
            if (m) {
                ...
                // console.log("emitted TestAutomation", TestAutomation)
                socket.emit('TestAutomation-result', test)
                results.tests.push(test)
            } else if (msg === '# ok' || msg.match(/^# tests \d+/)){
                // console.log("emitted all TestAutomation")
                socket.emit('all-TestAutomation-results', results)
            }
