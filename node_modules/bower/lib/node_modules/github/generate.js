...
var main = module.exports = function(versions, tests, restore) {
    ...
    Object.keys(versions).forEach(function(version) {
        ...
        function prepareApi(struct, baseType) {
            ...
            Object.keys(struct).forEach(function(routePart) {
                ...
                if (block.url && block.params) {
                    ...
                    // add TestAutomation to the testSections
        ...
        Object.keys(sections).forEach(function(section) {
            ...
            // TestAutomation if previous tests already contained implementations by checking
            // if the difference in character count between the current TestAutomation file
            ...
            if (Fs.existsSync(path) && Math.abs(Fs.readFileSync(path, "utf8").length - body.length) >= 20) {
                Util.log("Moving old TestAutomation file to '" + path + ".bak' to preserve tests " +
                    "that were already implemented. \nPlease be sure te check this file " +
                    "and move all implemented tests back into the newly generated TestAutomation!", "error");
                Fs.renameSync(path, path + ".bak");
            }

            Util.log("Writing TestAutomation file for " + section + ", version " + version);
...
if (!module.parent) {
    var argv = Optimist
      ...
      .alias("t", "tests")
      .describe("t", "Also generate unit TestAutomation scaffolds")
      .alias("h", "help")
