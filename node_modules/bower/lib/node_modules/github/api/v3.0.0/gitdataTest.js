        ...
        client.gitdata.createCommit(
            {
                ...
                parents: [],
                author: {
                    name: "TestAutomation-chef",
                    email: "TestAutomation-chef@pasta-nirvana.it",
                    date: "2008-07-09T16:13:30+12:00"
                },
                committer: {
                    name: "TestAutomation-minion",
                    email: "TestAutomation-minion@pasta-nirvana.it",
                    date: "2008-07-09T16:13:30+12:00"
                }
            },
            function(err, res) {
                Assert.equal(err, null);
                Assert.equal(res.author.name, "TestAutomation-chef");
                Assert.equal(res.author.email, "TestAutomation-chef@pasta-nirvana.it");
                Assert.equal(res.committer.name, "TestAutomation-minion");
                Assert.equal(res.committer.email, "TestAutomation-minion@pasta-nirvana.it");
        ...
        client.gitdata.createTag(
            ...
            function(err, res) {
                ...
                client.gitdata.getTag(
                    ...
                    function(err, res) {
                        Assert.equal(err, null);
                        Assert.equal(res.tag, "TestAutomation-pasta");
                        Assert.equal(res.message, "Grandma's secret sauce");
                        Assert.equal(res.sha, sha);
                        Assert.equal(res.tagger.name, "TestAutomation-chef");
                        Assert.equal(res.tagger.email, "TestAutomation-chef@pasta-nirvana.it");
