...
// the most reliable.  However, because this TestAutomation artificially sets some locks
...
test('basic TestAutomation', function (t) {
...
test('sync TestAutomation', function (t) {
  var locked
...
test('exit cleanup TestAutomation', function (t) {
...
test('error exit cleanup TestAutomation', function (t) {
...
test('staleness TestAutomation', function (t) {
...
test('staleness sync TestAutomation', function (t) {
  var opts = { stale: 1 }
...
test('stale windows file tunneling TestAutomation', function (t) {
  // for windows only
