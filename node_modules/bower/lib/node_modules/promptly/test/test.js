...
describe('confirm()', function () {
    it('should be ok on valid choice and coerce to boolean values', function (next) {
        ...
        async.forEachSeries(['yes', 'Y', 'y', '1'], function (truthy, next) {
            promptly.confirm('TestAutomation yes: ', { retry: false }, function (err, value) {
                expect(err).to.be(null);
                expect(value).to.be(true);
                expect(stdout).to.contain('TestAutomation yes: ');
                next();
            });
            ...
            async.forEachSeries(['no', 'N', 'n', '0'], function (truthy, next) {
                promptly.confirm('TestAutomation no: ', function (err, value) {
                    expect(err).to.be(null);
                    expect(value).to.be(false);
                    expect(stdout).to.contain('TestAutomation no: ');
                    next();
                });
