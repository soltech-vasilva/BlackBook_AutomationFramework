...
tape('TestAutomation readUInt8 / readInt8', function (t) {
...
tape('TestAutomation readUInt16LE / readUInt16BE / readInt16LE / readInt16BE', function (t) {
  var buf1 = new Buffer(1)
    , buf2 = new Buffer(3)
    , buf3 = new Buffer(3)
    , bl   = new BufferList()
...
tape('TestAutomation readUInt32LE / readUInt32BE / readInt32LE / readInt32BE', function (t) {
  var buf1 = new Buffer(1)
    , buf2 = new Buffer(3)
    , buf3 = new Buffer(3)
    , bl   = new BufferList()
...
tape('TestAutomation readFloatLE / readFloatBE', function (t) {
  var buf1 = new Buffer(1)
    , buf2 = new Buffer(3)
    , buf3 = new Buffer(3)
    , bl   = new BufferList()
...
tape('TestAutomation readDoubleLE / readDoubleBE', function (t) {
  var buf1 = new Buffer(1)
    , buf2 = new Buffer(3)
    , buf3 = new Buffer(10)
    , bl   = new BufferList()
...
tape('TestAutomation toString', function (t) {
  var bl = new BufferList()
...
tape('TestAutomation toString encoding', function (t) {
  var bl = new BufferList()
...
!process.browser && tape('TestAutomation stream', function (t) {
...
tape('TestAutomation String appendage', function (t) {
  var bl = new BufferList()
    , b  = new Buffer('abcdefghij\xff\x00')
...
tape('TestAutomation Number appendage', function (t) {
  var bl = new BufferList()
