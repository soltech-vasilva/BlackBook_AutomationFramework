...
describe('signal-exit', function () {
  ...
  it('receives an exit event when a process exits normally', function (done) {
    exec(process.execPath + ' ./TestAutomation/fixtures/end-of-execution.js', function (err, stdout, stderr) {
  ...
  it('receives an exit event when a process is terminated with sigint', function (done) {
    exec(process.execPath + ' ./TestAutomation/fixtures/sigint.js', function (err, stdout, stderr) {
      assert(err)
  ...
  it('receives an exit event when a process is terminated with sigterm', function (done) {
    exec(process.execPath + ' ./TestAutomation/fixtures/sigterm.js', function (err, stdout, stderr) {
      assert(err)
  ...
  it('receives an exit event when process.exit() is called', function (done) {
    exec(process.execPath + ' ./TestAutomation/fixtures/exit.js', function (err, stdout, stderr) {
  ...
  it('does not exit if user handles signal', function (done) {
    exec(process.execPath + ' ./TestAutomation/fixtures/signal-listener.js', function (err, stdout, stderr) {
      assert(err)
  ...
  it('ensures that if alwaysLast=true, the handler is run last (signal)', function (done) {
    exec(process.execPath + ' ./TestAutomation/fixtures/signal-last.js', function (err, stdout, stderr) {
      assert(err)
  ...
  it('ensures that if alwaysLast=true, the handler is run last (normal exit)', function (done) {
    exec(process.execPath + ' ./TestAutomation/fixtures/exit-last.js', function (err, stdout, stderr) {
      assert.ifError(err)
      stdout.should.match(/first counter=1/)
      stdout.should.match(/last counter=2/)
      done()
  ...
  it('works when loaded multiple times', function (done) {
    exec(process.execPath + ' ./TestAutomation/fixtures/multiple-load.js', function (err, stdout, stderr) {
      assert(err)
  ...
  // TODO: TestAutomation on a few non-OSX machines.
  it('removes handlers when fully unwrapped', function (done) {
    exec(process.execPath + ' ./TestAutomation/fixtures/unwrap.js', function (err, stdout, stderr) {
  ...
  it('does not load() or unload() more than once', function (done) {
    exec(process.execPath + ' ./TestAutomation/fixtures/load-unload.js', function (err, stdout, stderr) {
      assert.ifError(err)
      done()
    })
  })
  ...
  it('handles uncatchable signals with grace and poise', function (done) {
    exec(process.execPath + ' ./TestAutomation/fixtures/sigkill.js', function (err, stdout, stderr) {
      assert.ifError(err)
      done()
    })
  })
