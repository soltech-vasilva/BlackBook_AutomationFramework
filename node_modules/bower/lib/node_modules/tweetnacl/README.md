...
and then open `TestAutomation/browser/TestAutomation.html` (or `TestAutomation/browser/TestAutomation-fast.html`) to
run them.
...
To run benchmarks in a browser, open `TestAutomation/benchmark/bench.html` (or
`TestAutomation/benchmark/bench-fast.html`).
