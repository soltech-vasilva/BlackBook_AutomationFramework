...
describe('abort()', function () {
    ...
    it('exits process when not in TestAutomation mode', function (done) {
    ...
    it('throws when not in TestAutomation mode and abortThrow is true', function (done) {
    ...
    it('throws in TestAutomation mode', function (done) {
    ...
    it('throws in TestAutomation mode with default message', function (done) {
...
describe('assert()', function () {
    ...
    it('throws an Error when using assert in a TestAutomation', function (done) {
    ...
    it('throws an Error when using assert in a TestAutomation with no message', function (done) {
    ...
    it('throws an Error when using assert in a TestAutomation with multipart message', function (done) {
    ...
    it('throws an Error when using assert in a TestAutomation with multipart message (empty)', function (done) {
    ...
    it('throws an Error when using assert in a TestAutomation with object message', function (done) {
    ...
    it('throws an Error when using assert in a TestAutomation with multipart string and error messages', function (done) {
    ...
    it('throws an Error when using assert in a TestAutomation with error object message', function (done) {
...
describe('uniqueFilename()', function () {
    ...
    it('generates a random file path', function (done) {
        ...
        var result = Hoek.uniqueFilename('./TestAutomation/modules');

        expect(result).to.exist();
        expect(result).to.be.a.string();
        expect(result).to.contain('TestAutomation/modules');
        done();
    });
