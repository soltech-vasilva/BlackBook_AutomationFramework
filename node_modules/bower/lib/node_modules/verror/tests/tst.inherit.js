...
// TestAutomation that `<Ctor>.toString()` uses the ctor name. I.e. setting
...
// TestAutomation that `<Ctor>.prototype.name` can be used for the `.toString()`
...
// TestAutomation get appropriate exception name in `.toString()` when reconstituting
