...
test('\nstring configs resolve from type and root', function (t) {
  var code = 'var a = new TestAutomation();'
  ...
  run(t, { _default: '*:' }, 'var a = new TestAutomation();')

  t.test('\n\n# only before or after specified, but no root._default', function (t) {
    run(t, { Keyword: { _default: '*:' } }, '*var a = *new TestAutomation();')
    run(t, { Keyword: { _default: ':-' } }, 'var- a = new- TestAutomation();')
    t.end()
  })

  t.test('\n\n# resolve missing from root._default', function (t) {
    run(t, { Keyword: { _default: '*:' }, _default: '(:-' }, '*var- a = *new- TestAutomation();')
    run(t, { Keyword: { _default: ':-' }, _default: '*:)' }, '*var- a = *new- TestAutomation();')
    t.end()
  })
  ...
  t.test('\n\n# resolve specific token no defaults', function (t) {
    run(t, { Keyword: { 'var': '*:' } }, '*var a = new TestAutomation();')
    run(t, { Keyword: { 'var': ':-' } }, 'var- a = new TestAutomation();')
    t.end()
  })

  t.test('\n\n# resolve specific token with type defaults', function (t) {
    run(t, { Keyword: { 'var': '*:', _default: ':-' } }, '*var- a = new- TestAutomation();')
    run(t, { Keyword: { 'var': '*:', _default: '(:-' } }, '*var- a = (new- TestAutomation();')
    run(t, { Keyword: { 'var': ':-', _default: '*:' } }, '*var- a = *new TestAutomation();')
    run(t, { Keyword: { 'var': ':-', _default: '*:)' } }, '*var- a = *new) TestAutomation();')
    run(t, { Keyword: { 'var': ':-', 'new': ':&', _default: '*:' } }, '*var- a = *new& TestAutomation();')
    t.end()
  })
  ...
  t.test('\n\n# resolve specific token with type and root defaults', function (t) {
    run(t, { Keyword: { 'var': '*:', _default: '+:-' }, _default: ':)' }, '*var- a = +new- TestAutomation();')
    run(t, { Keyword: { 'var': ':-', _default: '*:+' }, _default: '(:' }, '*var- a = *new+ TestAutomation();')
    t.end()
  })
