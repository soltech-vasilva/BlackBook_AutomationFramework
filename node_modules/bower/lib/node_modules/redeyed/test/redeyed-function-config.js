...
test('\nfunction config, keywords', function (t) {
  ...
  t.test('\n# ' + inspect(opts001), function (t) {
    ...
    t.assertSurrounds('var n = new TestAutomation();', opts001, '*var& n = *new& TestAutomation();')
    t.assertSurrounds(
        [ 'function foo (bar) {'
        , ' var a = 3;'
        , ' return bar + a;'
...
test('#\n functin config - resolving', function (t) {
  ...
  t.test('\n# specific but no type default and root default - root default not applied' + inspect(opts001), function (t) {
    t.assertSurrounds('var n = new TestAutomation();', opts001, '^var& n = new TestAutomation();').end();
  })
  ...
  t.test('\n# no type default but root default' + inspect(opts002), function (t) {
    t.assertSurrounds('var n = new TestAutomation();', opts002, '^var& n = *new& TestAutomation();').end();
  })
})
...
test('#\n function config - replacing', function (t) {
  ...
  t.test('\n# type default and root default (type wins)' + inspect(opts001), function (t) {
    t.assertSurrounds('var n = new TestAutomation();', opts001, 'const n = new TestAutomation();').end();
  })
  ...
  t.test('\n# type default' + inspect(opts002), function (t) {
    t.assertSurrounds('var n = new TestAutomation();', opts002, 'const n = const TestAutomation();').end();
  })
  ...
  t.test('\n# specific and type default' + inspect(opts003), function (t) {
    t.assertSurrounds('var n = new TestAutomation();', opts003, 'const n = NEW TestAutomation();').end();
  })
  ...
  t.test('\n# type default and root default (type wins)' + inspect(opts004), function (t) {
    t.assertSurrounds('var n = new TestAutomation();', opts004, 'VAR n = NEW TestAutomation();').end();
  })
  ...
  t.test('\n# no type default only root default - not applied' + inspect(opts005), function (t) {
    t.assertSurrounds('var n = new TestAutomation();', opts005, 'var n = new TestAutomation();').end();
  })
})
