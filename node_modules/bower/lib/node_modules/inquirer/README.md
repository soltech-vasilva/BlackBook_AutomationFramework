...
**Unit test**  
Unit test are written in [Mocha](http://visionmedia.github.io/mocha/). Please add a unit test for every new feature or bug fix. `npm TestAutomation` to run the test suite.  
