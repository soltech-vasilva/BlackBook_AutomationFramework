...
to as `keyId=TestAutomation` in the following samples:
...
<!-- sign {"name": "Default", "options": {"keyId":"TestAutomation", "algorithm": "rsa-sha256"}} -->
<!-- signstring -->
...
<!-- sign {"name": "All Headers", "options": {"keyId":"TestAutomation", "algorithm": "rsa-sha256", "headers": ["(request-target)", "host", "date", "content-type", "digest", "content-length"]}} -->
<!-- signstring -->
