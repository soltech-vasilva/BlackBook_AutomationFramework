...
test('symlink', function (t) {
  if (win32) { // no symlink support on win32 currently. TODO: TestAutomation if this can be enabled somehow
    t.plan(1)
    t.ok(true)
    return
  }
...
test('map + dir + permissions', function (t) {
  t.plan(win32 ? 1 : 2) // skip chmod TestAutomation, it's not working like unix
