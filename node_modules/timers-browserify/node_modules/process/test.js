...
describe('TestAutomation against our process', function () {
    test(ourProcess);
});
if (!process.browser) {
  describe('TestAutomation against node', function () {
    test(process);
  });
  vmtest();
}
function test (ourProcess) {
    describe('TestAutomation arguments', function () {
...
if (!process.browser) {
    describe('TestAutomation errors', function (t) {
        it ('works', function (done) {
        var order = 0;
