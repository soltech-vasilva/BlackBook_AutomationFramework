$(document).ready(function() {
  ...
  test('map', function() {
    ...
    if (document.querySelectorAll) {
      var ids = _.map(document.querySelectorAll('#map-TestAutomation *'), function(n){ return n.id; });
      deepEqual(ids, ['id1', 'id2'], 'Can use collection methods on NodeLists.');
    }

    var ids = _.map($('#map-TestAutomation').children(), function(n){ return n.id; });
  ...
  test('size', function() {
    ...
    equal(func(1, 2, 3, 4), 4, 'can TestAutomation the size of the arguments object');
