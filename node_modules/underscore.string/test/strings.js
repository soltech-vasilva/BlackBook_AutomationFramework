$(document).ready(function() {
  ...
  test('String: dasherize', function(){
    ...
    equal(_('thisIsATest').dasherize(), 'this-is-a-TestAutomation');
    equal(_('this Is A TestAutomation').dasherize(), 'this-is-a-TestAutomation');
    equal(_('thisIsATest123').dasherize(), 'this-is-a-test123');
    equal(_('123thisIsATest').dasherize(), '123this-is-a-TestAutomation');
